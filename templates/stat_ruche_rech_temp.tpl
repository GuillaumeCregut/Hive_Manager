...
<body>
  <h1 id="titre">Relev&eacute; des temp&eacute;ratures</h1>
<p>Ruche : {$Ruche}</p>
<p>Les relev&eacute;s s'appuient sur les donn&eacute;es provenant des visites et du datalogger si il y en a un. Dans ce cas, ce sont les temp&eacute;ratures ext&eacute;rieures qui sont prises en compte.</p>
<p>Si aucune visite n'est renseign&eacute;e avec des temp&eacute;ratures, mais qu'il y a un datalogger, il faut afficher alors les statistiques du datalogger.</p>
